							...
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								...
								<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
									<ul style="width: 500px;margin-top: 30px; list-style: none;">
										<li style="margin-top: -19px; margin-left: 125px;" class="active"><a href="#"><span><i class="	glyphicon glyphicon-record	"></i></span> Việt nam</a></li>
									</ul>
								</div>
								...
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<button type="resert" class="btn-inverse btn">Làm mới</button>
									</div>
								</div>
